        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/flormery/Pruebas.git'
                }
            }
        }
        stage('Build') {
